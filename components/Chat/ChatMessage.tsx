        ...
        <div className="prose mt-[-2px] w-full dark:prose-invert">
          ...
          (
            ...
            <>
              ...
              {
                (message.type && message.type === 'product' && message.items && message.items.length > 0)?(
                  <>
                  ...
                  <div className="flex flex-row overflow-x-scroll bg-gray-800 p-2">
                  {message.items.map((item, index) => {

                    console.log(item, '314');
                    return(
                      <ProductCard
                        name={item.name}
                        color={item.color}
              ...
              {/* {
                (message.type && message.type === 'text') && <span>{message.content}</span>
              }
              {
                (message.type && message.type === 'products' && message.items && message.items.length > 0) ? (
                  message.items.map((item, index) => <span key={index}>{item}</span>)
                ) : (
                  <h1>No Products</h1>
                )
              } */}
